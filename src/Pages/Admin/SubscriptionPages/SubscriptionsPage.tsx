...
const SubscriptionsPage = () => {
  ...
  }, [refetchSubscriptions]); // Empty dependency array to only call refetch once on mount
  ...
  const handleDelete = async (id: number, name: string) => {
    const success = await deleteData(
      `${apiUrl}/admin/package/delete/${id}`,
      `تم حذف الاشتراك ${name} بنجاح.`
    );
