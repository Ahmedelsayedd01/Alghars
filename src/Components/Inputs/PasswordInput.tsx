      ...
      <div className="relative w-full h-14">
        <input
          ...
          className={classNames(
            `w-full h-full border-2 rounded-2xl outline-none px-2 py-8 text-3xl shadow bg-${backgound} font-TextFontRegular text-thirdColor`,
        ...
        {show ? (
          <IoMdEye
            className={`absolute top-7/12 transform -translate-y-2/4 ${
